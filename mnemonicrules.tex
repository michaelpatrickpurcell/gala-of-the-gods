...
\setkomafont{section}{\setmainfont{Roboto-Black}\color{black}\Large}
\setkomafont{subsection}{\setmainfont{Roboto-Black}\color{black}\large}
\setkomafont{subsubsection}{\setmainfont{Roboto-Black}\color{black}\normalsize}
